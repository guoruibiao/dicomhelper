...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fanniming = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.fanniming.setObjectName("fanniming")
        self.horizontalLayout_3.addWidget(self.fanniming)
